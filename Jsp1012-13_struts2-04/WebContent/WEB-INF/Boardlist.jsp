			...
			<tr>
				<th colspan="6">
					...
					<select name="searchType" >
						<option name="searchType" value="">선택</option>
						<option name="searchType" value="1">제목</option>
						<option name="searchType" value="2" >작성자</option>
						<option name="searchType"value="3">내용</option>
					</select>
