...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<ul class="pagination">
				<li><a
					href="<c:url value='/search_bbs1List?currentpage=${pagingData.prev_pageno}&searchType=${searchData.searchType}&searchValue=${searchData.searchValue}&orderType=${searchData.orderType}'/>">«</a></li>
				...
				<c:forEach var="iter" begin="${pagingData.page_sno}"
					...
					<a href="<c:url value='/search_bbs1List?currentpage=${iter}&searchType=${searchData.searchType}&searchValue=${searchData.searchValue}&orderType=${searchData.orderType}'/>"><b>${iter}</b></a>
					</li>
					</c:if>
					<c:if test="${iter != pageno}">
					<li id="pagination">
				...
				<li><a
					href="<c:url value='/search_bbs1List?currentpage=${pagingData.next_pageno}&searchType=${searchData.searchType}&searchValue=${searchData.searchValue}&orderType=${searchData.orderType}'/>">»</a></li>
			</ul>
		</div>
		</div>
		<div class="col-sm-9">
